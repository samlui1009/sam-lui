...
import { SiMongodb, SiJupyter, SiJunit5, SiVite, SiCss3, SiJson, SiFigma, SiJavascript } from 'react-icons/si';
...
function ProjectGrid() {
    return (
        ...
        <div className="grid-container">
            ...
            stack = {[FaReact, SiVite, SiCss3, SiJavascript, SiMongodb, SiFigma]}>
            </ProjectCard>
